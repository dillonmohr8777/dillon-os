...
Homepage portfolio replacement. Experience mode: the work leads immediately, while direct navigation and proof remain legible.

## Audience, job, action, proof, constraints

Recruiters, hiring leaders, executives, and collaborators must understand Dillon's hands-on senior-marketing range through one deep body of Align HCM work, inspect live public proof, watch selected edits, and contact him. No unrelated client or prospect work appears. Only public-safe evidence ships. Snapshot metrics are dated and scoped. No invented metrics, confidential materials, visible emojis, inaccessible scroll gates, hover-only actions, or motion without a reduced-motion counterpart.
...
The mirror uses three public-facing Align HCM edits and public links only. The 436-position U.S. organic snapshot is dated August 12, 2026; the six Google AI Overview cited pages, 85 total AI-search cited pages, and 107-post HubSpot library are dated August 25, 2026. The new Netlify mirror is created only after production QA passes.
