...
| Phase | Lanes | Mode |
|-------|--------|------|
| 0 | CLI preflight (`frontmatter-validate`, `site-health`, `queue-status`) | Deterministic |
| 1 | gmail-intel, slack-intel, vault-pulse, codex-session-sync, domain-ads-seo, websites, outreach, content-routines (if day-gated) | Parallel (max 8) |
| 2 | memory-consolidator | Sequential |

CLI scaffold: `node _os/automation/bin/competitive-task-orchestrator.js --preflight --date YYYY-MM-DD`
