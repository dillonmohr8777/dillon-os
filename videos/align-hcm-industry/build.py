...
icon set, the client logos, and the hero artwork.
...
def assets_js():
    ...
    # The SmartCare mark is no longer inlined. It used to open the past go-live
    # beat and was pulled from this film; the artwork stays in assets/logos so
    # the SmartCare film can still reach it.
