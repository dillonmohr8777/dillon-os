...
# Parked for now, re add by uncommenting:
...
def border_bg_mask(rgb, white=228, chroma=26):
    """True where a near white pixel is reachable from the image border.

    Four connected flood fill, so enclosed white (HiBob's "Hi", the counter of
    a letter O) is left alone.
    """
