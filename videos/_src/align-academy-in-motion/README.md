...
**Output:** `videos/align-academy-in-motion.mp4` — 1920×1080, 30fps, 1350 frames, exactly 45.000s, silent (both reference films are silent too).
...
| Vertex shuffling for the Academy benefits/services | Two shuffle-stack scenes (`WHO WE TRAIN`, `WHAT'S INSIDE`) — centre row sharp and lit, neighbours faded and blurred, list glides between rows |
...
| Logo at beginning and end only | Particle logo 0.0–4.4s and 41.7–45.0s. Nowhere else |
...
| Frames | Time | Scene |
| --- | --- | --- |
| 0–132 | 0.0–4.4s | Particle logo assembles, holds, bursts |
| 132–282 | 4.4–9.4s | Statement: *"A system either transforms your operations — or it gathers dust."* |
| 282–500 | 9.4–16.7s | `WHO WE TRAIN` — Administrators / Managers / Employees |
| 500–748 | 16.7–24.9s | `HOW WE DELIVER` — workshops / virtual / e-learning / reinforcement |
| 748–968 | 24.9–32.3s | `WHAT'S INSIDE` — role-based design / learning paths / practice environments / post-launch |
| 968–1148 | 32.3–38.3s | `WHY IT MATTERS` — outcome constellation |
| 1148–1252 | 38.3–41.7s | Closing: *"Empower your team to maximize your HCM investment."* |
| 1252–1350 | 41.7–45.0s | Particle logo reassembles + alignhcm.com |
...
Roughly 1.3s per frame single-threaded; run 2–4 workers over disjoint `FROM`/`TO` ranges.
