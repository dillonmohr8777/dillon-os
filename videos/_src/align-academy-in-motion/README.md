# Align Academy brand film

45s brand film for Align Academy™ (the Training service on alignhcm.com), built to sit
alongside the existing Align brand intro and Align Industry Solutions films.

The on-screen "Align in Motion" footer tag was removed at Ben's request: it came out of
