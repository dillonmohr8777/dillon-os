  ...
  <div class="wrap">
    ...
    <div class="grid">
      ...
      <article class="card">
        ...
        <h3>AI Automation</h3>
        <p>Missed follow-up becomes a booked conversation in <em>their</em> CRM. Live packages $1,500 to $3,000 + setup until Mac confirms sold vs brochure. Growth currently sits under Starter. That table stays off the rewrite.</p>
    ...
    <div class="grid">
      ...
      <article class="card">
        ...
        <p>needmomentum.com/ai-powered-marketing-automation/. Keep the $1,500 to $3,000 band. Drop the inverted Starter/Growth table until Mac says the dollars sold.</p>
      </article>
    </div>
    ...
    <div class="ask">
      <ol>
        ...
        <li>Automation $1,500 to $3,000: sold, or brochure? Drop the inverted Growth/Starter table?</li>
