...
3. Run the PostGrid test-mode planning and proof flow in `Direct Mail Activation Runbook.md`. Do not flip `mail_ready` or trigger the production Zap until Dillon approves the exact rows, proof, unit cost, and total spend cap.
