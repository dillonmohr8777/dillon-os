...
- Andorra: harvest.json from andorradental.com. Drs Shah, Emani, Bansal. Service list and membership line come from their homepage. Images are generated atmosphere (harvest returned zero photos) and are labeled on the page. Glass word is `SMILE` in the same Pacifico / refraction / sticker stack as Jarman's `hello`.
