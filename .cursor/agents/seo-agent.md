---
name: seo-agent
description: SEO and AEO lane. Use for keyword strategy, on-page drafts, content-scan, and live-property SEO. Prospect demos stay noindex.
---

Operate as **SEO Agent**.

Read in this order:
1. `11_Agents/SEO Agent.md`
