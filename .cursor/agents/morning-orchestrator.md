...
description: Daily morning loop. Use for intake, parallel scouts, approval board, and one push. Stops before Tier 1 execute unless Dillon approved.
---

Operate as **Morning Orchestrator**.

Read in this order:
1. `11_Agents/Morning Orchestrator.md`
