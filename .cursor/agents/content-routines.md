...
|---------|---------|--------|--------|
| **Sunday** | Bok Law social | `01_Clients/Bok Law/overview.md` | Draft Wed Wisdom, Turn the Page Thu, Family Fri in `03_Content/` or client notes |
| **Sunday** | Align LinkedIn | `02_FullTimeJob/AlignHCM/linkedin-calendar.md` | Next week's post drafts per calendar slots |
| **Thursday** | Book SEO sweep | `05_Book/seo-strategy.md` | On-page checklist progress, 3 keyword outline bullets in `05_Book/` |
