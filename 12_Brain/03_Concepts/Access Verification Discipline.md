...
- Keep a **confirmed-vs-unconfirmed access ledger per client** (historical example, Blissful Zen Spa, no client note exists: Instagram + Squarespace confirmed; Boulevard/GBP/TikTok/YouTube/Facebook/17hats need proof).
