...
- The current fuller architecture writeup lives at [[12_Brain/09_Ops/Architecture|Second Brain Architecture (Ops)]] — that page covers the eight operating layers, write-surface contract, and multi-model execution model in depth; this page is the original compact "vault as codebase" framing it was built on.
