...
- Pin Bridge's unified review to exact name `bridge-connected-signal` and host `bridge-connected-signal.netlify.app`. Never create a site from a publish script. Never deploy Trusted Current to that host.
