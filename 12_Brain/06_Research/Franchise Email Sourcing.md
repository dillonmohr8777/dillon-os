...
Afternoon receipts: [[12_Brain/01_Captures/research/2026-08-14 Franchise Email Sourcing Receipts]].
Evening receipts: [[12_Brain/01_Captures/research/2026-08-14 Franchise Send-Ready Harvest]].
Lane A/C/D + radar flip: [[12_Brain/01_Captures/research/2026-08-15 Franchise Lanes A-C-D Receipts]].
...
- **Lane A:** Item 20 is names + phones ([16 CFR § 436.5(t)](https://www.law.cornell.edu/cfr/text/16/436.5)). **MN CARDS + WI DFI** still serve no-login FDD PDFs (MN 403 to bots; use a browser). CA DocQNet is **not** a public FDD library in 2026 (FRANSES + PRA). IN is captcha. MD has no corpus. Zero new emails (correct). Second-pass receipt: [[12_Brain/01_Captures/research/2026-08-15 Franchise Lane A Portal Probe]].
...
- Lane A owner-name enrichment on the existing 720 (MN CARDS + WI DFI only) for LinkedIn/GBP DMs. Private ledger, no Item 20 tables in git.
