...
| 330M, ~16k context | Small enough to sit beside a local LLM | Google blog; HF model card; TimesFM 2.5 context carried forward |
...
| TimesFM 2.5 remains Apache-2.0 | Legal local univariate + XReg path until a commercial 3.0 route exists | GitHub README |
...
- Group 32 contiguous steps into a patch. Per-series normalization like 2.5.
...
- TimesFM 2.5 is univariate plus XReg covariates. It is the current
  production-legal local option. It is not the native multivariate 3.0 model.
...
- This machine has not loaded either checkpoint during this research pass.
