...
action — see the automation registry entry in `12_Brain/registry/automations.json`
...
**Composition only.** The [[12_Brain/02_Entities/Website Factory|Website Factory]]
