...
**Summary:** turn Mac’s four-page AI nav into four internal offers, three live service pages, one Loom, and 90-day pilots on current clients before outbound scale.

Play: [[12_Brain/concepts/Need Momentum AI Division]]. Collateral: [[12_Brain/concepts/AI Division Collateral]]. Offers: [[05_Offers/Offer Index]].

## Goal

Need Momentum can sell AI as a service line (not a product company) without looking AI-washed, without copying Seer/WebFX, and without waiting on a 300-skill dump.
...
- Building a public AEO SaaS.
- Citation guarantees.
- Auto-sending mail or CRM writes.
- Selling Dillon’s HubSpot agent as a named product before it runs on client accounts.
