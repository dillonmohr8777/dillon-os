...
- Keep a **confirmed-vs-unconfirmed access ledger per client** (worked example: Blissful Zen Spa — no page in the current roster — Instagram + Squarespace confirmed; Boulevard/GBP/TikTok/YouTube/Facebook/17hats need proof).
