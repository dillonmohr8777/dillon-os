...
- Haoqi radar craft demos publish only through `_os/automation/bin/haoqi-craft-deploy.js`, pinned to `haoqi-radar-craft`. That script refuses workshop, radar, IMMOHRTAL, and Philly hub names.
...
## Links
- [[12_Brain/entities/Website Factory|Website Factory]] · [[12_Brain/concepts/Evidence Boundaries in Reporting|Evidence Boundaries in Reporting]]
