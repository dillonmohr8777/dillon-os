...
Loop learn output, last 14 day(s): **12** concrete lesson(s), **181** explicit no-finding(s), **2** promotion candidate(s). Recorded per execution in the loop receipts; the latest brief lists them.
