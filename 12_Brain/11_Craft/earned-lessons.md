...
- **Installed is not live.** Playwright MCP timed out on the extension bridge. Isolated Chrome on 9223 dump-dom'd and screenshotted example.com. Camofox is the stealth engine when `:9377` is healthy. Evidence: [[12_Brain/01_Captures/research/2026-08-18 - isolated Chrome browser access receipt]].
