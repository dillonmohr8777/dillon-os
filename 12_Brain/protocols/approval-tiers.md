...
| 2 | Outbound / irreversible | email send, Slack post, public deploy, mail merge, spending, credential use, Higgsfield/Krea/Mistral generate, account connect |
...
- `/seedance`, `/krea-2`, and `/mistral-ocr` draft only; generate, connect, or spend stays Tier 2
- A TikTok roundup is not permission to authenticate Higgsfield or claim 4K
