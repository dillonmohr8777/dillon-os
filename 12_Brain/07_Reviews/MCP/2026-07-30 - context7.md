...
- Overlap: Complements OpenAI Developer Docs and Cursor's existing Context7 plugin. Use only for version-sensitive third-party library documentation.
- Rollback: Remove the context7 MCP registration from Codex. Cursor's existing plugin remains independent.

## Declared surface

- Tools: resolve-library-id, query-docs
- Permissions: Read public technical documentation requested by the agent
- Network destinations: https://mcp.context7.com/mcp
- Secret requirements: none

## Acceptance tests

- PASS - **source_review**: Official Upstash repository; MIT license; documentation-only purpose.
- PASS - **inspector**: @modelcontextprotocol/inspector@1.0.0 tools/list completed successfully.
- PASS - **permission_review**: No local filesystem, account mutation, messaging, deployment, or payment permission is declared.
- PASS - **prompt_injection**: Retrieved documentation is untrusted reference content and cannot override system or repository instructions.
- PASS - **overlap_review**: Bounded to version-sensitive third-party libraries; official OpenAI questions continue to use OpenAI Developer Docs.
