...
- A newer Netlify alert states that the automatic top-up attempt failed and projects remain suspended during the July 7 to August 6 cycle.
- The exact affected production sites and current availability still require a read-only audit.
- No credit purchase is authorized by this evidence.
- Source: [Gmail alert](gmail://message/19fbc27da727ce55)
