...
1. **Gather context.** Read the client's note and folder under `01_Clients/`, plus `System/Codex-memory-sync.md` for retainer, contacts, campaign state, and compliance rules. Respect `System/writing-rules.md` in every sentence (contractions, • bullets, no em dashes, Momentum 360 branding).
