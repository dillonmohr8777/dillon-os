...
|----------|------------------|---------|-------|-----|
| **P0** | Codex Slack connector | `oauth_refresh_token_rejected` / `reauthentication_required` — Codex Slack plugin session expired; Slack web login is separate. Blocks all Slack MCP reads and Slack AI reintegration until interactive reconnect on each desktop. **6 days open** since 2026-07-22. | Dillon (operator) | ASAP |
...
| **P1** | Jason Fallon DM | **EOM agenda — Chatbot** — classify as built, tested, blocked, or approval-required with current evidence by EOM. | Dillon / Sean | **2026-07-31 (3 days)** |
| **P1** | Jason Fallon DM | **EOM agenda — CallRail after-hours & SMS** — classify status with evidence. No SMS activation, phone routing changes, spend, or outbound messages without explicit approval. | Dillon / Sean | **2026-07-31 (3 days)** |
| **P1** | Jason Fallon DM | **EOM agenda — Internal Agent workflows** — classify setups and workflows with evidence. Preserve account ownership, opt-out behavior, rollback, and test evidence. | Dillon / Sean | **2026-07-31 (3 days)** |
...
- No new Slack-derived actions since Run 34; connector reauth remains the highest-leverage unblock.
