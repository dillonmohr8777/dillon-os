...
|----------|------------------|---------|-------|-----|
| **P0** | Codex Slack connector | `oauth_refresh_token_rejected` / `reauthentication_required` — Codex Slack plugin session expired; Slack web login is separate. Blocks all Slack MCP reads and Slack AI reintegration until interactive reconnect on each desktop. **8 days open** since 2026-07-22. | Dillon (operator) | ASAP |
