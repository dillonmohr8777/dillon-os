...
• Bar Crawl USA ($950/mo) — active, 2 Google Ads disapprovals unresolved (~94 days).
• Kimberly James Bridal ($300/mo) — active, Timeline page + GA4/GSC still open.
• Shadow HVAC ($250/mo) — active, LSA status needs verification after 2026-03-02 reset (~138 days).
• LinkEZE ($300/mo) — active, enhanced conversions diagnostics + MFA overdue (~104 days).
