...
- BOK Law — active, **Jun/Jul social backlog unshipped**; Jul 25 Family Fridays due today; Jul 24 Turn the Page 1 day overdue.
...
- Bridge Software Development — active-discovery, Tori meeting capture **12 days overdue**.

## Full-time

- Align HCM — Dillon's full-time employer. Not a client. Overdue LinkedIn posts: Maher Jul 15 (**10 days**), Joann Jul 13 (**12 days**), Joann Jul 21 payroll (**4 days**).

## Pending deliverables

- **BOK Law** — Ship Jun 23, Jun 30, Jul 7, Jul 14, Jul 21 week files; publish Jul 25 Family Fridays today; Jul 24 Turn the Page 1 day overdue; Jul 23 Wisdom 2 days overdue.
- **Align HCM** — Ship overdue Maher + Joann posts; publish Jul 21 Joann payroll post (4 days overdue).
- **Bridge Software Development** — Capture Tori 2026-07-13 meeting outcome; send follow-up (12 days overdue).
...
- **2026-07-25** — BOK Family Fridays (today).
...
- 2026-07-25 — Competitive task orchestrator run 32; umbrella system ported to consolidation branch.
- 2026-07-24 — Competitive task orchestrator run 31.
- 2026-07-23 — Competitive task orchestrator run 30; umbrella infrastructure restored on consolidation branch.

## Unanswered / urgent

- **BOK Law** — Entire Jun/Jul social backlog unshipped; Jul 23 Wisdom 2 days overdue; Jul 24 Turn the Page 1 day overdue; Jul 25 Family Fridays due today.
- **Align HCM** — Maher Jul 15 (**10 days**), Joann Jul 13 (**12 days**), Joann Jul 21 payroll (**4 days**) all overdue.
- **Bridge** — Tori meeting outcome not captured post-2026-07-13 (**12 days**).
