...
• Bar Crawl USA ($950/mo) — active, 2 Google Ads disapprovals unresolved (~90 days).
• Kimberly James Bridal ($300/mo) — active, Timeline page + GA4/GSC still open.
• Shadow HVAC ($250/mo) — active, LSA status needs verification after 2026-03-02 reset (~134 days).
• LinkEZE ($300/mo) — active, enhanced conversions + MFA overdue on 809-600-6448 (~100 days).
• Omega Landscaping ($200/mo) — active, chasing David for drone footage.
• Jeff Hozias / Rand Realty ($200/mo) — active, Meta seller campaign approved 2026-04-14, not launched (~91 days).
• Fresh Blends / Replenish ($500/mo) — active, confirm launch + week-1 snapshot.
• BOK Law — active, weekly social cadence; Jul 9 posts unshipped (5 days overdue), Jul 14 week drafts ready.
• NKCDC — active, BLOCKED on Free Tax Prep landing page (~90 days).
• Commercial Cleaners Alliance — onboarding, creative delivery audit due.
• Hardwood Artisan ($150/mo) — AT RISK, billing card update outstanding since 2026-04-07 (~98 days).
• Onsite Concrete & Landscape — active, standing Thursday 1:00 PM ET call.
• Bridge Software Development — discovery complete 2026-07-11; Tori decision package due 2026-07-13 — **post-meeting capture overdue**.

## Full-time
• Align HCM — Dillon's full-time employer. Not a client. Jul 15 Maher post drafted 2026-07-12 (**due tomorrow**); Jul 21 SmartCare video still needs asset.
...
• Align HCM — ship overdue week files; review/record Jul 15 Maher script.
• Bridge Software Development — capture Tori meeting outcome; send follow-up with decisions.

## Upcoming deadlines (7 days)
• 2026-07-14 — Bridge post-meeting capture + content backstack ship (today).
...
• **Hardwood Artisan** — Sean's 2026-04-07 billing request still outstanding (~98 days).
• **Bar Crawl USA** — 2 disapproved ads need resolution (~90 days).
...
• **BOK Law** — Jul 9 posts missed (5 days); three overdue week files unshipped.
• **Bridge** — Tori meeting outcome not captured in vault.
