...
AGENTS = [
    dict(
        ...
        skills=['plan-today', 'am-report', 'inbox-brief', 'client-pulse', 'week-review', 'slack-intake',
                'ask-dillon-skills', 'grill-with-docs', 'unslop'],
    ...
    dict(
        ...
        skills=['site-factory', 'site-batch', 'frontend-build', 'ui-design', 'ux-audit',
                ...
                'tdd', 'diagnosing-bugs', 'implement', 'unslop'],
    ...
    dict(
        ...
        skills=['ux-audit', 'frontend-build', 'code-review', 'unslop'],
    ...
    dict(
        ...
        skills=['client-report', 'metrics-pull', 'unslop'],
    ...
    dict(
        ...
        skills=['content-scan', 'research-sweep', 'unslop'],
