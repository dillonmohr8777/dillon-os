...
The vault was reconciled on 2026-07-12 against current work from the rolling three-week window. The April-era client roster is superseded. On 2026-09-05 Fagan Painting, Shadow Heating & Cooling, and Jeff Hozias were retired to `_archive/01_Clients/` (see `System/client-roster-reconciliation-2026-09-05.md`).

## Active roster

- Paid media and growth: Kimberly James Bridal, Omega Landscaping & Concrete, On-Site Concrete & Landscape, Replenish, Capsule & Tonic.
...
- Confirmed blue-dashboard accounts: Kimberly James Bridal, Omega, and Onsite.
