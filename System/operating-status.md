...
- Web research uses [[12_Brain/09_Ops/Web Escalation Architecture|the web ladder]]. Cursor Desktop full local runtime (including screenshots and `claude-code` MCP on new sessions) was granted 2026-08-18; outbound verbs were not.
