...
Also read the latest `Daily-Briefs/radar-*.md` and `System/approval-queue.md` for outreach and gated actions.

If Gmail or Slack MCP is unavailable, each intel agent must note `source: vault-fallback` and rely on `System/claude-memory-sync.md`, `System/urgent-replies.md`, and `12_Brain/07_Reviews/2026-08-15 - 120-Day Slack Operating System Audit.md` — do not fail the run.
