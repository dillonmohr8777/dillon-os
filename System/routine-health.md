...
- `indeed-marketing-job-scrape` — scrapes Indeed every morning at 6:00 AM for 25 brand-new marketing job postings matching the roles in `02_FullTimeJob/job-search/target-roles.md`; writes Markdown to `02_FullTimeJob/job-search/indeed-today.md` and a CSV to `02_FullTimeJob/job-search/indeed-today.csv`; emails the CSV to `dillonmohr8777@gmail.com` at 7:30 AM ET.
...
- 2026-04-29: Removed `bok-law-social-content`. Added `indeed-marketing-job-scrape` (scrape 6:00 AM ET; CSV email to dillonmohr8777@gmail.com at 7:30 AM ET).
