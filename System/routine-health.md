...
last_orchestrator_run: 2026-07-19
...
|------|--------|----------|-------|
| gmail-intel | 🟡 fallback | 2026-07-19 | MCP not connected; using `System/urgent-replies.md` |
| slack-intel | 🟡 fallback | 2026-07-19 | MCP not connected; using `System/slack-action-queue.md` |
| vault-pulse | 🟢 ok | 2026-07-19 | 14 overviews scanned; frontmatter frozen April 2026 |
| codex-session-sync | 🟢 ok | 2026-07-19 | 20 sessions; run 26 on 4eb0 branch |
| domain-ads-seo | 🟢 ok | 2026-07-19 | 3 High / 2 Medium / 2 Low in Google Ads queue |
| content-routines | 🟢 ok | 2026-07-19 | Sunday — drafted BOK + Align week of Jul 21 |
| memory-consolidator | 🟢 ok | 2026-07-19 | Brief + claude-memory-sync updated (run 26) |
...
- Bridge Tori meeting outcome not captured post-2026-07-13 (6 days overdue)
