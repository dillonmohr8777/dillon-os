...
last_orchestrator_run: 2026-07-06
...
## Orchestrator lane status (run 13 — 2026-07-06)
...
| Sessions | `codex-session-sync` | 🟡 partial | 6 files; run 12 carry-forward; no new Codex exports |
| Ads/SEO | `domain-ads-seo` | 🟢 ok | 5 P0s in campaign queues |
| Content | `content-routines` | ⚪ skipped | Monday — not Sun/Thu; Sunday drafts on disk |
