...
Delegated: Vite, React, TypeScript, Three.js, React Three Fiber, and the preserved raw WebGL robot renderer. This keeps the proven primary-portfolio particle system and the original business site's efficient shared-canvas agents while remaining a static, portable web build.
...
- 21 verified public-safe client and partner logo assets and seven public web project previews from the primary portfolio.
...
1. Proof arrives before explanation.
2. The public agent roster must correspond to real executable infrastructure.
...
Target WCAG 2.2 AA. Support visible focus, semantic landmarks, 44-pixel targets, readable contrast, pauseable animation, a complete reduced-motion sequence, descriptive media text, and meaningful static fallbacks when WebGL or JavaScript is unavailable.
