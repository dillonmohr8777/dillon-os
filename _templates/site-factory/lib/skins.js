...
.slug-${slug} .gallery-grid figure,.slug-${slug} .moments figure,.slug-${slug} .cinematic-frame{border-radius:2px}
...
.slug-${slug} .hero-media figure,.slug-${slug} .offering-card,.slug-${slug} .gallery-grid figure,.slug-${slug} .moments figure,.slug-${slug} .cinematic-frame,.slug-${slug} .catalog-card,.slug-${slug} .contact-card,.slug-${slug} .story figure,.slug-${slug} .feature figure{border-radius:0;box-shadow:12px 12px 0 var(--ink)}
...
.slug-${slug} .hero-media figure,.slug-${slug} .gallery-grid figure,.slug-${slug} .moments figure,.slug-${slug} .cinematic-frame{border-radius:4px;filter:contrast(1.05) saturate(.92)}
