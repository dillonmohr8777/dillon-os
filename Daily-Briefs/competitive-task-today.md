# Competitive Task — 2026-07-10

## Coverage

- **Gmail:** fallback — MCP not connected; `System/urgent-replies.md` refreshed from vault (2026-07-10).
...
- **Sessions:** 10 files scanned (runs 12–16 restored; Facebook Ads stubs empty). Run 17 logged. Codex export path still absent on cloud runner.
...
- **Content routines:** **skipped** — not a content routine day (Sunday/Thursday only). BOK + Align drafts still unshipped — **1 day past Jul 9 post day**.
...
2. **Hardwood Artisan** — Billing card update outstanding since Sean's 2026-04-07 escalation (~94 days). Only client marked `at_risk`. Engagement pause risk.
3. **NKCDC** — Launch blocked on Free Tax Prep landing page; Anthony unresponsive since Mac's 2026-04-15 follow-up (~86 days). Escalate with Mac today.
4. **Bar Crawl USA** — Resolve 2 Google Ads disapprovals (Halloween / Fall Cocktail Crawl). Andy waiting since Dillon's 2026-04-15 investigate reply (~86 days).
5. **Jeff Hozias** — Meta seller campaign approved 2026-04-14, ~87 days not live. Log account ID + pixel, then launch.

**Next tier:** LinkEZE enhanced conversions + MFA (~94 days overdue on 809-600-6448).
...
|--------|--------------|-----------|
| Shadow HVAC | 2026-03-02 | LSA verification after reset (~130 days) |
...
- **Friday 2026-07-10** — content-routines skipped (not Sun/Thu)
- **Overdue ship** — BOK Wednesday Wisdom (Jul 9) + Align SmartCare post still in `03_Content/` drafts
- **Sunday 2026-07-12** — Next BOK + Align LinkedIn draft generation (`content-routines`); also Align July 15 Maher post blocker per handoff

## Tomorrow Prep

1. **Saturday** — Confirm any Friday ships went out; update `last_touched` on touched client notes.
2. **Sunday 2026-07-12** — content-routines runs: BOK social + Align LinkedIn drafts.
