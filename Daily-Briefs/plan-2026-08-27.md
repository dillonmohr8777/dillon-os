...
1. **Paid-media truth** - Ads LIST recovered (16 customers). Campaign GAQL still 403 without manager login-customer-id. No pause/enable/budget. Replenish invite untouched.
2. **Web finish lines and company outreach** - preview LPs photo-complete, publish gated. Radar ready=4. Packet 1 do-not-pitch. Packet 2 still 429 last check. Packets 3-4 hospital extra hold. `mail_ready=hold`.
...
cycle `CREW-20260827-080104437` dry_run=False