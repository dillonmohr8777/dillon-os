...
1. **Paid-media truth** - Ads LIST recovered (16 customers). Child GAQL still 403 without login-customer-id. Schema re-inspected; no GAQL this tick. GSC 2026-08-21..25: Shadow 1/26, Onsite 6/715, KJB 20/1964, agency 0/3. Meta stays read-only.
2. **Web finish lines and company outreach** - packets remain hold. Packet 1 DO NOT PITCH. Packet 2 national-franchise extra hold. Packets 3-4 extra hold. Preview LPs 0/3 fail for publish. `mail_ready=hold`.
...
cycle `CREW-20260827-160051965` dry_run=False