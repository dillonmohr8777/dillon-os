...
| **Status after create** | Leave paused until Dillon enables. New campaign is Tier 2. |
...
- Do not enable the campaign without Dillon. Create paused.
- Do not copy prior PMax structure or dump leftover Search keywords into this campaign.

## Apply checklist (operator)

1. Create the Search campaign with the name, networks, geo, bid, and budget rule above. Leave paused.
...
5. Dillon enables when ready. Meta stays primary.
