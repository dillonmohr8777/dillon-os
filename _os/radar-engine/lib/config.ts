...
function loadConfig(overrides = {}) {
  ...
  const cfg = {
    ...
    staging: envBool('RADAR_V2_STAGING', false),
    ...
    captchaSiteKey: process.env.RADAR_V2_CAPTCHA_SITE_KEY || '',
    captchaExpectedHostname: process.env.RADAR_V2_CAPTCHA_EXPECTED_HOSTNAME || '',
    captchaExpectedAction: process.env.RADAR_V2_CAPTCHA_EXPECTED_ACTION || 'intake',
    ...
    brandName: process.env.MOMENTUM_BRAND_NAME || 'Momentum Digital',
    contactName: process.env.MOMENTUM_CONTACT_NAME || 'Momentum Digital',
    contactEmail: process.env.MOMENTUM_CONTACT_EMAIL || 'hi@needmomentum.com',
    contactUrl: process.env.MOMENTUM_CONTACT_URL || 'https://needmomentum.com',
    bookingUrl: process.env.MOMENTUM_BOOKING_URL || 'https://calendly.com/needmomentum/marketing-strategy',
