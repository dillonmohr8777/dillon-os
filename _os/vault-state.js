...
function getBrainVitals(vault) {
  ...
  return {
    ...
    // Machine-write surfaces — automation-emitted records (see 12_Brain/README.md)
    captures: countMdIn(vault, path.join(BRAIN, '01_Captures')),
    experiments: countMdIn(vault, path.join(BRAIN, '05_Projects')),
...
function requiredBrainPaths() {
  return [
    ...
    '12_Brain/System/Model Roster.md',
    '12_Brain/System/Skill Registry.md',
    '12_Brain/System/Upgrade Log.md',
    'CLAUDE.md',
    'INDEX.md',
    ...
    '.claude/skills/model-scout/SKILL.md',
    '.claude/skills/skill-scout/SKILL.md',
    '.claude/skills/stack-sync/SKILL.md',
