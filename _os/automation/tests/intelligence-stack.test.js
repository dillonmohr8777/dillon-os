...
test('Grok research synthesis is connected to durable brain hubs', () => {
  const note = renderResearchHeader('2026-08-03', ['https://example.com/source']);
  assert.match(note, /\[\[12_Brain\/00_Home\|Brain Home\]\]/);
  assert.match(note, /\[\[12_Brain\/05_Projects\/2026-07-30 - Integrate daily intelligence stack\|Daily intelligence stack\]\]/);
  assert.match(note, /\[\[12_Brain\/03_Concepts\/Marketing Intelligence Operating System\|Marketing intelligence operating system\]\]/);
});
