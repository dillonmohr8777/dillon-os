...
**Summary:** the vault is a codebase — raw/ is ground truth, entities/ and
...
The agent's job is compiling: read new material in `raw/`, update the entity
...
- Operations: [[System/Second Brain Ops|Second Brain Ops]]
