---
name: dillon-command
description: Company OS Umbrella CLI — runs eleven parallel intel/scout lanes then memory-consolidator. Replaces fragmented morning loops and seven afternoon crons. Profile company-os-umbrella is canonical.
---

# Company OS Umbrella (Dillon Command CLI)

One umbrella workflow for Dillon's competitive daily loop. Replaces running
`/slack-intake`, `/inbox-brief`, `/client-pulse`, separate afternoon crons,
and duplicate competitive-task consolidation runs.

Contract: `System/competitive-task-definition.md`  
Spec: `11_Agents/company-os-umbrella-spec.md`  
Prompt: `System/company-os-umbrella-prompt.md`  
CLI: `node _os/automation/bin/dillon-command.js --profile company-os-umbrella`  
Profile: `_os/automation/profiles/company-os-umbrella.json`

## When to use

- Daily Cursor automation at 1:00 PM ET (`company-os-umbrella`)
- Any time Dillon asks for "the competitive task" or "what should I work on"
- 64GB Codex commander session startup (preflight + lane map)
